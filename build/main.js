// elm-watch hot {"version":"1.1.0","targetName":"My target name","webSocketPort":54362}
"use strict";
(() => {
...
var $author$project$Main$CispString = function (a) {
	return {$: 'CispString', a: a};
};
var $bburdette$websocket$WebSocket$Connect = function (a) {
	return {$: 'Connect', a: a};
};
var $author$project$Cisp$Invalid = function (a) {
	return {$: 'Invalid', a: a};
};
var $author$project$Parameter$Pitch = {$: 'Pitch'};
var $author$project$Main$SelectedCisp = F2(
	function (a, b) {
		return {$: 'SelectedCisp', a: a, b: b};
	});
var $author$project$Cisp$Valid = function (a) {
	return {$: 'Valid', a: a};
};
...
var $author$project$CispField$addTrailingSpace = function (array) {
	var size = $elm$core$Array$length(array);
	var _v0 = A2($elm$core$Array$get, size - 1, array);
	if ((_v0.$ === 'Just') && (' ' === _v0.a.valueOf())) {
		return array;
	} else {
		return A2(
			$elm$core$Array$push,
...
var $author$project$CispField$deleteChar = function (model) {
	var prev = A2($elm$core$Basics$max, model.cursorIndex - 1, 0);
	return _Utils_update(
		model,
		{
			cursorIndex: prev,
			field: A2($elm_community$array_extra$Array$Extra$removeAt, prev, model.field)
		});
};
var $author$project$CispField$deleteCurrentChar = function (model) {
	return _Utils_update(
		model,
		{
			field: A2($elm_community$array_extra$Array$Extra$removeAt, model.cursorIndex, model.field)
		});
};
...
var $author$project$CispField$allowedSymbols = function (c) {
	var allowed = $elm$core$String$toList('()+-*/_. ');
	return A2($elm$core$List$member, c, allowed);
};
...
var $author$project$CispField$filter = function (str) {
	...
	var alphnum = function (c) {
		return ($elm$core$Char$isAlphaNum(c) || $author$project$CispField$allowedSymbols(c)) ? $elm$core$Maybe$Just(c) : $elm$core$Maybe$Nothing;
	};
	return A2(
...
var $author$project$CispField$gotoEndOfLine = function (model) {
	return _Utils_update(
		model,
		{
			cursorIndex: $elm$core$Array$length(model.field)
		});
};
var $author$project$CispField$gotoStartOfLine = function (model) {
	return _Utils_update(
		model,
		{cursorIndex: 0});
};
...
var $author$project$CispField$handleArrows = F2(
	function (marrow, model) {
		_v0$2:
		while (true) {
			if ((marrow.$ === 'Just') && (marrow.a.$ === 'KeyDown')) {
				switch (marrow.a.a.$) {
					case 'ArrowLeft':
						var _v1 = marrow.a.a;
						var _v2 = A2($elm$core$Debug$log, 'arrow left', model.cursorIndex);
						return _Utils_update(
							model,
							{
								cursorIndex: A2($elm$core$Basics$max, model.cursorIndex - 1, 0)
							});
					case 'ArrowRight':
						var _v3 = marrow.a.a;
						var _v4 = A2($elm$core$Debug$log, 'arrow left', model.cursorIndex);
						return _Utils_update(
							model,
							{
								cursorIndex: A2(
									$elm$core$Basics$min,
									model.cursorIndex + 1,
									$elm$core$Array$length(model.field))
							});
					default:
						break _v0$2;
				}
...
var $author$project$CispField$applyKeyboard = F3(
	function (pressedKeys, keyChange, model) {
		var withTrail = _Utils_update(
			model,
			{
				field: $author$project$CispField$addTrailingSpace(model.field)
			});
		var newModel = A2($author$project$CispField$handleArrows, keyChange, withTrail);
		var controlPressed = A2($elm$core$List$member, $ohanhi$keyboard$Keyboard$Control, pressedKeys);
		var _v0 = _Utils_Tuple2(controlPressed, keyChange);
		_v0$3:
		while (true) {
			if (_v0.a) {
				if (((_v0.b.$ === 'Just') && (_v0.b.a.$ === 'KeyUp')) && (_v0.b.a.a.$ === 'Character')) {
					switch (_v0.b.a.a.a) {
						case 'e':
							return $author$project$CispField$gotoEndOfLine(newModel);
						case 'a':
							return $author$project$CispField$gotoStartOfLine(newModel);
						case 'd':
							return $author$project$CispField$deleteCurrentChar(newModel);
						default:
							break _v0$3;
					}
				} else {
				...
				if (_v0.b.$ === 'Just') {
					if (_v0.b.a.$ === 'KeyUp') {
						...
						switch (_v0.b.a.a.$) {
							case 'Backspace':
								var _v1 = _v0.b.a.a;
								return $author$project$CispField$deleteChar(newModel);
							case 'Character':
								var any = _v0.b.a.a.a;
								var _v2 = $author$project$CispField$filter(any);
								if (_v2.$ === 'Just') {
									var c = _v2.a;
									return _Utils_update(
										newModel,
										{
											...
											field: A3($elm_community$array_extra$Array$Extra$insertAt, newModel.cursorIndex, c, newModel.field)
										});
								} else {
									return newModel;
								}
...
var $author$project$Main$OneVoice = F4(
	function (pitch, velo, channel, duration) {
		return {channel: channel, duration: duration, pitch: pitch, velo: velo};
	});
...
var $author$project$CispField$decoder = A2(
	$elm$json$Json$Decode$map,
	function (str) {
		return {
			cursorIndex: 0,
			field: $elm$core$Array$fromList(
...
var $author$project$Main$decodeVoice = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Main$OneVoice,
	A2($elm$json$Json$Decode$field, 'pitch', $author$project$CispField$decoder),
	A2($elm$json$Json$Decode$field, 'velo', $author$project$CispField$decoder),
	A2($elm$json$Json$Decode$field, 'channel', $author$project$CispField$decoder),
	A2($elm$json$Json$Decode$field, 'duration', $author$project$CispField$decoder));
var $bburdette$websocket$WebSocket$Send = function (a) {
	return {$: 'Send', a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Parameter$toString = function (p) {
	switch (p.$) {
		case 'Pitch':
			return 'pitch';
		case 'Velo':
...
var $author$project$Main$handleAction = F2(
			...
			if (action.a.$ === 'Update') {
				...
				var address = A2(
					...
					_List_fromArray(
						[
							idxstr,
							$author$project$Parameter$toString(par)
						]));
				return _Utils_Tuple2(
					model,
					$author$project$Main$wssend(
						$bburdette$websocket$WebSocket$Send(
							{content: '/' + (address + (' ' + str)), name: 'cisp'})));
			} else {
				var _v2 = action.a;
				var idx = _v2.a;
				var param = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selected: A2($author$project$Main$SelectedCisp, idx, param)
						}),
					$elm$core$Platform$Cmd$none);
			}
		}
	});
var $author$project$Main$nextVoice = function (model) {
	var length = $elm$core$Array$length(model.cisps);
	var _v0 = model.selected;
	var idx = _v0.a;
	var par = _v0.b;
	return _Utils_eq(idx, length - 1) ? A2($author$project$Main$SelectedCisp, 0, par) : A2($author$project$Main$SelectedCisp, idx + 1, par);
};
var $author$project$Main$previousVoice = function (model) {
	var length = $elm$core$Array$length(model.cisps);
	var _v0 = model.selected;
	var idx = _v0.a;
	var par = _v0.b;
	return (!idx) ? A2($author$project$Main$SelectedCisp, length - 1, par) : A2($author$project$Main$SelectedCisp, idx - 1, par);
};
var $author$project$Parameter$Channel = {$: 'Channel'};
var $author$project$Parameter$Duration = {$: 'Duration'};
var $author$project$Parameter$Velo = {$: 'Velo'};
var $author$project$Main$nextParameter = function (p) {
	switch (p.$) {
		case 'Pitch':
			return $author$project$Parameter$Velo;
		case 'Velo':
			return $author$project$Parameter$Duration;
		case 'Duration':
			return $author$project$Parameter$Channel;
		default:
			return $author$project$Parameter$Pitch;
	}
};
var $author$project$Main$selectedNextParameter = function (_v0) {
	var n = _v0.a;
	var p = _v0.b;
	return A2(
		$author$project$Main$SelectedCisp,
		n,
		$author$project$Main$nextParameter(p));
};
var $author$project$Main$previousParameter = function (p) {
	switch (p.$) {
		case 'Pitch':
			return $author$project$Parameter$Channel;
		case 'Channel':
...
var $author$project$Main$selectedPreviousParameter = function (_v0) {
	var n = _v0.a;
	var p = _v0.b;
	return A2(
		$author$project$Main$SelectedCisp,
		n,
		$author$project$Main$previousParameter(p));
};
var $author$project$Main$handleUpDownArrows = F2(
	function (change, model) {
		var shiftDown = A2($elm$core$List$member, $ohanhi$keyboard$Keyboard$Shift, model.keyboard.keys);
		if (shiftDown) {
			_v0$2:
			while (true) {
				if ((change.$ === 'Just') && (change.a.$ === 'KeyDown')) {
					switch (change.a.a.$) {
						case 'ArrowDown':
							var _v1 = change.a.a;
							return _Utils_update(
								model,
								{
									selected: $author$project$Main$nextVoice(model)
								});
						case 'ArrowUp':
							var _v2 = change.a.a;
							return _Utils_update(
								model,
								{
									selected: $author$project$Main$previousVoice(model)
								});
						default:
							break _v0$2;
					}
					...
					switch (change.a.a.$) {
						case 'ArrowDown':
							...
							return _Utils_update(
								model,
								{
									selected: $author$project$Main$selectedNextParameter(model.selected)
								});
						case 'ArrowUp':
							var _v5 = change.a.a;
							return _Utils_update(
								model,
								{
									selected: $author$project$Main$selectedPreviousParameter(model.selected)
								});
						default:
							break _v3$2;
					}
...
var $author$project$CispField$init = function (initial) {
	return {
		cursorIndex: 0,
		field: $elm$core$Array$fromList(
			$elm$core$String$toList(initial))
	};
};
var $author$project$Main$initVoice = {
	channel: $author$project$CispField$init('(st 1)'),
	duration: $author$project$CispField$init('(st 0.1)'),
	pitch: $author$project$CispField$init('(st 60)'),
	velo: $author$project$CispField$init('(st 100)')
};
var $author$project$Main$input = '(seq 1 (seq 4 5) 3)';
...
var $author$project$Cisp$Depth = function (a) {
	return {$: 'Depth', a: a};
};
...
var $author$project$Cisp$ParClose = function (a) {
	return {$: 'ParClose', a: a};
};
var $author$project$Cisp$ParOpen = function (a) {
	return {$: 'ParOpen', a: a};
};
var $author$project$Cisp$Slist = function (a) {
	return {$: 'Slist', a: a};
};
var $author$project$Cisp$Value = function (a) {
	return {$: 'Value', a: a};
};
...
var $author$project$Cisp$increase = function (_v0) {
	var d = _v0.a;
	return $author$project$Cisp$Depth(d + 1);
};
...
var $author$project$Cisp$Space = {$: 'Space'};
...
var $author$project$Cisp$parseSpace = A2(
	$elm$parser$Parser$map,
	function (str) {
		return function (n) {
			return A2($elm$core$List$repeat, n, $author$project$Cisp$Space);
		}(
...
var $author$project$Cisp$CNumber = function (a) {
	return {$: 'CNumber', a: a};
};
...
var $author$project$Cisp$floaty = $elm$parser$Parser$number(
	{
...
var $author$project$Cisp$cispNumber = A2(
		...
		A2(
			...
			A2(
				...
				$elm$parser$Parser$succeed(
					F4(
						function (start, number, end, source) {
							return $author$project$Cisp$CNumber(
								{
									representation: A3($elm$core$String$slice, start, end, source),
									value: number
								});
						})),
				$elm$parser$Parser$getOffset),
			$author$project$Cisp$floaty),
		$elm$parser$Parser$getOffset),
	$elm$parser$Parser$getSource);
var $author$project$Cisp$CString = function (a) {
	return {$: 'CString', a: a};
};
var $author$project$Cisp$CispWord = function (a) {
	return {$: 'CispWord', a: a};
};
var $author$project$Cisp$cispwords = _List_fromArray(
	['seq', 'line', 'ch', 'rv', 'walk', 'transcat', 'cycle', 'st', 'index', '+', '-', '/', '~', 't']);
var $author$project$Cisp$parseString = function (str) {
	return A2($elm$core$List$member, str, $author$project$Cisp$cispwords) ? $author$project$Cisp$CispWord(str) : $author$project$Cisp$CString(str);
};
var $author$project$Cisp$value = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			$author$project$Cisp$cispNumber,
			A2(
			$elm$parser$Parser$map,
			$author$project$Cisp$parseString,
			$elm$parser$Parser$getChompedString(
				A2(
...
var $author$project$Cisp$complete = function () {
	var helper = F2(
		function (depth, expression_lst) {
			return A2(
									...
									function (v) {
										return $elm$parser$Parser$Loop(
											A2(
												$elm$core$List$cons,
												v,
												_Utils_ap(spaces, expression_lst)));
									},
									A2(
										$elm$parser$Parser$loop,
										_List_Nil,
										helper(
											$author$project$Cisp$increase(depth))))),
								A2(
								$elm$parser$Parser$map,
								function (trailingSpaces) {
									return $elm$parser$Parser$Done(
										$author$project$Cisp$Slist(
											A2(
												$elm$core$List$cons,
												$author$project$Cisp$ParOpen(depth),
												$elm$core$List$reverse(
													_Utils_ap(
														trailingSpaces,
														A2(
															$elm$core$List$cons,
															$author$project$Cisp$ParClose(depth),
															_Utils_ap(spaces, expression_lst)))))));
								},
								A2(
									$elm$parser$Parser$keeper,
									A2(
										...
										$elm$parser$Parser$succeed($elm$core$Basics$identity),
										$elm$parser$Parser$symbol(')')),
									$author$project$Cisp$parseSpace)),
								A2(
								$elm$parser$Parser$map,
								function (v) {
									return $elm$parser$Parser$Loop(
										A2(
											$elm$core$List$cons,
											$author$project$Cisp$Value(v),
											_Utils_ap(spaces, expression_lst)));
								},
								$author$project$Cisp$value),
								A2(
								$elm$parser$Parser$andThen,
								function (_v0) {
									return $elm$parser$Parser$problem('expecting closing parenthesis: )');
								},
		...
		A2(
			...
			A2(
				...
				A2(
					...
					_List_Nil,
					helper(
						$author$project$Cisp$Depth(0))),
				$elm$parser$Parser$spaces),
			$elm$parser$Parser$end));
}();
var $author$project$Cisp$sexpr = $author$project$Cisp$complete;
...
var $author$project$Main$mkAction = F3(
	function (voiceIndex, parameter, outMsg) {
		return A2(
			$elm$core$Maybe$map,
			function (out) {
				if (out.$ === 'Highlight') {
					return A2($author$project$Main$HighLight, voiceIndex, parameter);
				} else {
					var str = out.a;
					return A3($author$project$Main$Update, voiceIndex, parameter, str);
				}
			},
			outMsg);
	});
var $author$project$CispField$EvalString = function (a) {
	return {$: 'EvalString', a: a};
};
var $author$project$CispField$Highlight = {$: 'Highlight'};
var $elm$core$String$fromList = _String_fromList;
var $author$project$CispField$arrayToString = function (arr) {
	return $elm$core$String$fromList(
		$elm$core$Array$toList(arr));
};
var $author$project$CispField$update = F2(
	function (msg, model) {
		if (msg.$ === 'JumpToLocation') {
			var location = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{cursorIndex: location}),
				$elm$core$Maybe$Just($author$project$CispField$Highlight));
		} else {
			return _Utils_Tuple2(
				model,
				$elm$core$Maybe$Just(
					$author$project$CispField$EvalString(
						$author$project$CispField$arrayToString(model.field))));
		}
	});
var $author$project$Main$updatePar = F4(
	function (voiceIndex, parameter, msg, voice) {
		switch (parameter.$) {
			case 'Pitch':
				var _v1 = A2($author$project$CispField$update, msg, voice.pitch);
				var newPar = _v1.a;
				var outMsg = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						voice,
						{pitch: newPar}),
					A3($author$project$Main$mkAction, voiceIndex, parameter, outMsg));
			case 'Velo':
				var _v2 = A2($author$project$CispField$update, msg, voice.velo);
				var newPar = _v2.a;
				var outMsg = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					A3($author$project$Main$mkAction, voiceIndex, parameter, outMsg));
			case 'Duration':
				var _v3 = A2($author$project$CispField$update, msg, voice.duration);
				var newPar = _v3.a;
				var outMsg = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					A3($author$project$Main$mkAction, voiceIndex, parameter, outMsg));
			default:
				var _v4 = A2($author$project$CispField$update, msg, voice.channel);
				var newPar = _v4.a;
				var outMsg = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$updateArrayAtIndex = F3(
	function (idx, fupdate, array) {
		...
		if (_v0.$ === 'Just') {
			...
			return $elm$core$Result$Err('This index does not exist');
		}
	});
var $author$project$Main$updateSelectedCisp = F2(
	function (updateFun, model) {
		var updatePr = F2(
			function (para, voice) {
				switch (para.$) {
					case 'Pitch':
						return _Utils_update(
							voice,
							{
								pitch: updateFun(voice.pitch)
							});
					case 'Velo':
						return _Utils_update(
							voice,
							{
								velo: updateFun(voice.velo)
							});
					case 'Duration':
						return _Utils_update(
							voice,
							{
								duration: updateFun(voice.duration)
							});
					default:
						return _Utils_update(
							voice,
							{
								channel: updateFun(voice.channel)
							});
				}
			});
		var _v0 = model.selected;
		...
		var par = _v0.b;
		var _v1 = A3(
			$author$project$Main$updateArrayAtIndex,
			idx,
			updatePr(par),
			model.cisps);
		if (_v1.$ === 'Ok') {
			...
			var err = _v1.a;
			var _v2 = A2($elm$core$Debug$log, 'udpateSelectedCisp', err);
			return model;
		}
	});
...
var $author$project$Main$init = function (_v8) {
	return A2(
		$elm$core$Tuple$mapSecond,
		function (_v9) {
			return $author$project$Main$wssend(
				$bburdette$websocket$WebSocket$Connect(
					{address: 'ws://127.0.0.1:3000', name: 'cisp', protocol: 'json'}));
		},
		A2(
			$author$project$Main$update,
			$author$project$Main$CispString($author$project$Main$input),
			{
				cisp: $author$project$Cisp$Valid(''),
				cisps: $elm$core$Array$fromList(
					_List_fromArray(
						[$author$project$Main$initVoice, $author$project$Main$initVoice])),
				custom: '',
				json: '',
				keyboard: {change: $elm$core$Maybe$Nothing, keys: _List_Nil},
				selected: A2($author$project$Main$SelectedCisp, 0, $author$project$Parameter$Pitch)
			}));
};
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'CispString':
				var str = msg.a;
				var result = A2($elm$parser$Parser$run, $author$project$Cisp$sexpr, str);
				if (result.$ === 'Ok') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								cisp: $author$project$Cisp$Valid(str)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								cisp: $author$project$Cisp$Invalid(str)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'ReceivedFrame':
			...
			case 'KeyboardMsg':
				var kmsg = msg.a;
				var _v2 = A3($ohanhi$keyboard$Keyboard$updateWithKeyChange, $ohanhi$keyboard$Keyboard$anyKeyOriginal, kmsg, model.keyboard.keys);
				var newKeys = _v2.a;
				var change = _v2.b;
				var newModel = _Utils_update(
					model,
					{
						keyboard: {change: change, keys: newKeys}
					});
				var newModel2 = A2($author$project$Main$handleUpDownArrows, change, newModel);
				return _Utils_Tuple2(
					A2(
						$author$project$Main$updateSelectedCisp,
						A2($author$project$CispField$applyKeyboard, newKeys, change),
						newModel2),
					$elm$core$Platform$Cmd$none);
			case 'CispFieldMsg':
				var idx = msg.a;
				var parameter = msg.b;
				var fieldMsg = msg.c;
				var mvoice = A2($elm$core$Array$get, idx, model.cisps);
				if (mvoice.$ === 'Just') {
					var voice = mvoice.a;
					var _v4 = A4($author$project$Main$updatePar, idx, parameter, fieldMsg, voice);
					var newVoice = _v4.a;
					var maction = _v4.b;
					return A2(
						$author$project$Main$handleAction,
						maction,
						_Utils_update(
							model,
							{
								cisps: A3($elm$core$Array$set, idx, newVoice, model.cisps)
							}));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			...
			default:
				var _v5 = A2(
					...
					$author$project$Main$cyclic$decoder(),
					model.json);
				if (_v5.$ === 'Ok') {
					var _v6 = _v5.a;
					var m = _v6.a;
					...
					var e = _v5.a;
					var _v7 = A2($elm$core$Debug$log, 'json error', e);
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
	});
function $author$project$Main$cyclic$decoder() {
	return A2(
		$elm$json$Json$Decode$map,
		function (voices) {
			return function (_v10) {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							cisps: $elm$core$Array$fromList(voices)
						}),
					cmd);
			}(
		...
		A2(
			...
			'cisps',
			$elm$json$Json$Decode$list($author$project$Main$decodeVoice)));
}
try {
	var $author$project$Main$decoder = $author$project$Main$cyclic$decoder();
	$author$project$Main$cyclic$decoder = function () {
		return $author$project$Main$decoder;
	};
} catch ($) {
...
var $author$project$Main$ReceivedFrame = function (a) {
	return {$: 'ReceivedFrame', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Main$blurs = _Platform_incomingPort('blurs', $elm$json$Json$Decode$int);
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$bburdette$websocket$WebSocket$receive($author$project$Main$ReceivedFrame)),
				$author$project$Main$blurs(
				function (_v1) {
					return $author$project$Main$Blur;
				})
			]));
};
var $author$project$Main$ChangedJson = function (a) {
	return {$: 'ChangedJson', a: a};
};
var $author$project$Main$UpdateFromJson = {$: 'UpdateFromJson'};
...
var $author$project$Main$black = A3($mdgriffith$elm_ui$Element$rgb, 1.0, 1.0, 1.0);
...
var $author$project$Main$displaySelected = function (_v0) {
	var n = _v0.a;
	var par = _v0.b;
	return A2(
		...
		_List_fromArray(
			[
				...
				'Par is =' + $author$project$Parameter$toString(par)),
				$mdgriffith$elm_ui$Element$text(
				'Index =' + $elm$core$String$fromInt(n))
			]));
};
var $author$project$CispField$encode = function (model) {
	return $elm$json$Json$Encode$string(
		$author$project$CispField$arrayToString(model.field));
};
var $author$project$Main$encodeVoice = function (voice) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'pitch',
				$author$project$CispField$encode(voice.pitch)),
				_Utils_Tuple2(
				'velo',
				$author$project$CispField$encode(voice.velo)),
				_Utils_Tuple2(
				'channel',
				$author$project$CispField$encode(voice.channel)),
				_Utils_Tuple2(
				'duration',
				$author$project$CispField$encode(voice.duration))
			]));
};
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$author$project$Main$encodeVoice,
					$elm$core$Array$toList(model.cisps)))
			]));
};
...
var $author$project$Main$CispFieldMsg = F3(
	function (a, b, c) {
		return {$: 'CispFieldMsg', a: a, b: b, c: c};
	});
var $author$project$Main$isActive = F3(
	function (voice, par, _v0) {
		var i = _v0.a;
		var p = _v0.b;
		return _Utils_eq(voice, i) && _Utils_eq(par, p);
	});
...
var $author$project$CispField$Eval = {$: 'Eval'};
var $author$project$CispField$JumpToLocation = function (a) {
	return {$: 'JumpToLocation', a: a};
};
var $author$project$CispField$addPlaceCursorEvent = F2(
	function (clickMsg, arr) {
		var f = F2(
			function (idx, elm) {
				return A2(
					$mdgriffith$elm_ui$Element$el,
		...
		return A2($elm$core$List$indexedMap, f, arr);
	});
var $author$project$Cisp$Uncolored = function (a) {
	return {$: 'Uncolored', a: a};
};
var $author$project$Cisp$Colored = F2(
	function (a, b) {
		return {$: 'Colored', a: a, b: b};
	});
var $author$project$Cisp$cvalueToElement = function (cvalue) {
	switch (cvalue.$) {
		case 'CNumber':
			var representation = cvalue.a.representation;
			return A2(
				$elm$core$List$map,
				function (c) {
					return A2(
						$author$project$Cisp$Colored,
						c,
						A3($mdgriffith$elm_ui$Element$rgb, 0.0, 0.4, 0.0));
				},
				$elm$core$String$toList(representation));
		case 'CString':
			var str = cvalue.a;
			return A2(
				$elm$core$List$map,
				function (c) {
					return A2(
						$author$project$Cisp$Colored,
						c,
						A3($mdgriffith$elm_ui$Element$rgb, 0.4, 0.4, 0.0));
				},
				$elm$core$String$toList(str));
		default:
			var str = cvalue.a;
			return A2(
				...
				function (c) {
					return A2(
						$author$project$Cisp$Colored,
						c,
						A3($mdgriffith$elm_ui$Element$rgb, 0.4, 0.5, 0.0));
				},
				$elm$core$String$toList(str));
	}
};
...
var $author$project$Cisp$ofDepth = function (_v0) {
	...
	var _v1 = A2($elm$core$Basics$modBy, 6, c);
	switch (_v1) {
		case 0:
			return A3(rgb, 200, 30, 30);
		case 1:
			return A3(rgb, 30, 200, 30);
		case 2:
			return A3(rgb, 30, 30, 200);
		case 3:
			return A3(rgb, 50, 50, 100);
		case 4:
			return A3(rgb, 100, 50, 50);
		case 5:
			return A3(rgb, 100, 100, 100);
		default:
			return A3(rgb, 200, 100, 200);
	}
};
var $author$project$Cisp$renderTree = function (exp) {
	switch (exp.$) {
		case 'Slist':
			if (!exp.a.b) {
				return _List_Nil;
				...
				var lst = exp.a;
				return A2($elm$core$List$concatMap, $author$project$Cisp$renderTree, lst);
			}
		case 'Value':
			var v = exp.a;
			return $author$project$Cisp$cvalueToElement(v);
		case 'ParClose':
			var d = exp.a;
			return _List_fromArray(
				[
		...
		default:
			return _List_fromArray(
				[
					$author$project$Cisp$Uncolored(
					_Utils_chr(' '))
				]);
	}
};
var $author$project$Cisp$colorize = function (cispString) {
	var result = A2($elm$parser$Parser$run, $author$project$Cisp$sexpr, cispString);
	if (result.$ === 'Ok') {
		var res = result.a;
		return $author$project$Cisp$renderTree(res);
	} else {
		return A2(
			$elm$core$List$map,
			function (c) {
				return $author$project$Cisp$Uncolored(c);
			},
			$elm$core$String$toList(cispString));
	}
};
...
var $author$project$Cisp$toElem = F2(
	function (attrs, c) {
		if (c.$ === 'Colored') {
			var _char = c.a;
			var color = c.b;
...
var $author$project$CispField$markCursorAt = F3(
	function (idx, n, _char) {
		return _Utils_eq(n, idx) ? A2(
			$author$project$Cisp$toElem,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color(
					A3($mdgriffith$elm_ui$Element$rgb, 0.3, 0.3, 0.3))
				]),
			_char) : A2($author$project$Cisp$toElem, _List_Nil, _char);
	});
var $author$project$CispField$markCursor = F3(
	function (active, n, array) {
		return active ? A2(
			$elm$core$List$indexedMap,
			$author$project$CispField$markCursorAt(n),
			array) : A2(
			$elm$core$List$map,
			function (_char) {
				return A2($author$project$Cisp$toElem, _List_Nil, _char);
			},
			array);
	});
...
var $author$project$CispField$view = F2(
	function (isActive, model) {
		var field = A2(
			...
			A2(
				$author$project$CispField$addPlaceCursorEvent,
				function (idx) {
					return $author$project$CispField$JumpToLocation(idx);
				},
				A3(
					$author$project$CispField$markCursor,
					isActive,
					model.cursorIndex,
					$author$project$Cisp$colorize(
						$author$project$CispField$arrayToString(model.field)))));
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					{
						label: $mdgriffith$elm_ui$Element$text('eval'),
						onPress: $elm$core$Maybe$Just($author$project$CispField$Eval)
					})
				]));
	});
var $author$project$Main$parView = F4(
	function (voiceNumber, p, selectedCisp, cispField) {
		return A2(
			$mdgriffith$elm_ui$Element$map,
			A2($author$project$Main$CispFieldMsg, voiceNumber, p),
			A2(
				$author$project$CispField$view,
				A3($author$project$Main$isActive, voiceNumber, p, selectedCisp),
				cispField));
	});
...
var $author$project$Main$viewVoice = F3(
	function (idx, voice, selectedCisp) {
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($mdgriffith$elm_ui$Element$spacingXY, 40, 20)
				]),
			_List_fromArray(
				[
					A2(
					...
					$mdgriffith$elm_ui$Element$text(
						'Voice: ' + $elm$core$String$fromInt(idx + 1))),
					A4($author$project$Main$parView, idx, $author$project$Parameter$Pitch, selectedCisp, voice.pitch),
					A4($author$project$Main$parView, idx, $author$project$Parameter$Velo, selectedCisp, voice.velo),
					A4($author$project$Main$parView, idx, $author$project$Parameter$Duration, selectedCisp, voice.duration),
					A4($author$project$Main$parView, idx, $author$project$Parameter$Channel, selectedCisp, voice.channel)
				]));
	});
	...
	var jsonInput = A2(
		...
		_List_Nil,
		{
			label: A2(
				...
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('json')),
			onChange: $author$project$Main$ChangedJson,
			placeholder: $elm$core$Maybe$Nothing,
			text: model.json
		});
	var jsonButton = $author$project$Style$styledButton(
		{
			label: $mdgriffith$elm_ui$Element$text('update from json'),
			onPress: $elm$core$Maybe$Just($author$project$Main$UpdateFromJson)
		});
	var cispsView = A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
		...
		A2(
			$elm$core$List$cons,
			$mdgriffith$elm_ui$Element$text('use shift and arrows to switch between voices'),
			$elm$core$Array$toList(
				A2(
					$elm$core$Array$indexedMap,
					F2(
						function (idx, voice) {
							return A3($author$project$Main$viewVoice, idx, voice, model.selected);
						}),
					model.cisps))));
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Main$displaySelected(model.selected),
					cispsView,
					$mdgriffith$elm_ui$Element$text(
					A2(
